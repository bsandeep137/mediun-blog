...
export function Avatar({ authorName , size = "small" }: { authorName: string | undefined
    ...
    return <div style={{height: size === "small" ? "16px" : "24px", width: size === "small" ? "16px" : "24px"}} className={`inline-flex items-center justify-center h-${size === "small" ? 24 : 16} w-${size === "small" ? 24 : 16} rounded-full bg-gray-500 text-[.6rem] font-semibold text-white`}>
