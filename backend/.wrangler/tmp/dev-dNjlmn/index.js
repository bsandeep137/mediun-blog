...
// .wrangler/tmp/bundle-4TMoor/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-4TMoor/middleware-insertion-facade.js
init_modules_watch_stub();
...
blogRouter.use("/*", async (c, next) => {
  ...
  const user = await verify2("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjMzOThjNjNjLTVkMzgtNDExYi05YmE4LTlmNTJhZjg5MjJkMiJ9.6i8JUy67gS1ymElmTgiAE-dIVmTX7tnRFIjvMwEtYU4", c.env.JWT_SECRET);
